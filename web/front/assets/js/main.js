...
;(function () {
    ...
    /*
     ...
     note par etoiles page resultat

     */


    StarOutUrl = "{{ asset('front/assets/imgs/Staroff.gif') }}";      //image par défaut
    StarOverUrl = "{{ asset('front/assets/imgs/Staron.gif') }}";      //image d'une étoile sélectionnée
    ...
    function NotationSystem() {
        for (i = 1; i < NbStar + 1; i++) {
            ...
            img.onclick = function () {
                document.getElementById('resultat').innerHTML = Name2Nb(this.id);
            };
